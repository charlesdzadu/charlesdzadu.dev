			...
			<div class="flex flex-col ">
				...
				<div class="px-4 py-5 flex flex-col gap-2">
					<div class="flex gap-4 items-center" v-for="tech in technos" :key="tech.icon">
						<input type="checkbox" @change="addTechno(tech)" class="h-5 w-5 focus:ring-primary bg-transparent border focus:border-none rounded-sm checked:bg-gray focus:bg-gray" />
